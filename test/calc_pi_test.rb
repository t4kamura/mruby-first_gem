...
assert("CalcPI#babylonion_sqrt as Rational") do
  res = CalcPI.new.babylonion_sqrt(2)
  assert_equal(
    Rational(6632452706042512, 4689852284341727),
    res)
end

assert("CalcPI#babylonion_sqrt as Float") do
  res = CalcPI.new.babylonion_sqrt(2, as_f: true).to_s
